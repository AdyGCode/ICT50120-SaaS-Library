...
class BookSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $seedBooks = [
            ["title" => "Fundamentals of Wavelets", "author" => "Goswami, Jaideva", "genre" => "tech", "sub_genre" => "signal processing", "height" => 228, "publisher" => "Wiley",],
            ["title" => "Data Smart", "author" => "Foreman, John", "genre" => "tech", "sub_genre" => "data science", "height" => 235, "publisher" => "Wiley",],
            ["title" => "God Created the Integers", "author" => "Hawking, Stephen", "genre" => "tech", "sub_genre" => "mathematics", "height" => 197, "publisher" => "Penguin",],
            ["title" => "Superfreakonomics", "author" => "Dubner, Stephen", "genre" => "science", "sub_genre" => "economics", "height" => 179, "publisher" => "Harper Collins",],
            ["title" => "Orientalism", "author" => "Said, Edward", "genre" => "nonfiction", "sub_genre" => "history", "height" => 197, "publisher" => "Penguin",],
            ["title" => "Nature of Statistical Learning Theory, The", "author" => "Vapnik, Vladimir", "genre" => "tech", "sub_genre" => "data science", "height" => 230, "publisher" => "Springer",],
            ["title" => "Integration of the Indian States", "author" => "Menon, V P", "genre" => "nonfiction", "sub_genre" => "history", "height" => 217, "publisher" => "Orient Blackswan",],
            ["title" => "Drunkard's Walk, The", "author" => "Mlodinow, Leonard", "genre" => "science", "sub_genre" => "mathematics", "height" => 197, "publisher" => "Penguin",],
            ["title" => "Image Processing & Mathematical Morphology", "author" => "Shih, Frank", "genre" => "tech", "sub_genre" => "signal processing", "height" => 241, "publisher" => "CRC",],
            ["title" => "How to Think Like Sherlock Holmes", "author" => "Konnikova, Maria", "genre" => "nonfiction", "sub_genre" => "psychology", "height" => 240, "publisher" => "Penguin",],
            ["title" => "Data Scientists at Work", "author" => "Sebastian Gutierrez", "genre" => "tech", "sub_genre" => "data science", "height" => 230, "publisher" => "Apress",],
            ...
            ["title" => "Structure & Interpretation of Computer Programs", "author" => "Sussman, Gerald", "genre" => "tech", "sub_genre" => "computer science", "height" => 240, "publisher" => "MIT Press",],
            ["title" => "Age of Wrath, The", "author" => "Eraly, Abraham", "genre" => "nonfiction", "sub_genre" => "history", "height" => 238, "publisher" => "Penguin",],
            ["title" => "Trial, The", "author" => "Kafka, Frank", "genre" => "fiction", "sub_genre" => "classic", "height" => 198, "publisher" => "Random House",],
            ["title" => "Statistical Decision Theory'", "author" => "Pratt, John", "genre" => "tech", "sub_genre" => "data science", "height" => 236, "publisher" => "MIT Press",],
            ["title" => "Data Mining Handbook", "author" => "Nisbet, Robert", "genre" => "tech", "sub_genre" => "data science", "height" => 242, "publisher" => "Apress",],
            ...
            ["title" => "Making Software", "author" => "Oram, Andy", "genre" => "tech", "sub_genre" => "computer science", "height" => 232, "publisher" => "O'Reilly",],
            ["title" => "Analysis, Vol I", "author" => "Tao, Terence", "genre" => "tech", "sub_genre" => "mathematics", "height" => 248, "publisher" => "HBA",],
            ["title" => "Machine Learning for Hackers", "author" => "Conway, Drew", "genre" => "tech", "sub_genre" => "data science", "height" => 233, "publisher" => "O'Reilly",],
            ["title" => "Signal and the Noise, The", "author" => "Silver, Nate", "genre" => "tech", "sub_genre" => "data science", "height" => 233, "publisher" => "Penguin",],
            ["title" => "Python for Data Analysis", "author" => "McKinney, Wes", "genre" => "tech", "sub_genre" => "data science", "height" => 233, "publisher" => "O'Reilly",],
            ["title" => "Introduction to Algorithms", "author" => "Cormen, Thomas", "genre" => "tech", "sub_genre" => "computer science", "height" => 234, "publisher" => "MIT Press",],
            ["title" => "Beautiful and the Damned, The", "author" => "Deb, Siddhartha", "genre" => "nonfiction", "sub_genre" => "history", "height" => 198, "publisher" => "Penguin",],
            ...
            ["title" => "Mein Kampf", "author" => "Hitler, Adolf", "genre" => "nonfiction", "sub_genre" => "autobiography", "height" => 212, "publisher" => "Rupa",],
            ...
            ["title" => "Last Lecture, The", "author" => "Pausch, Randy", "genre" => "nonfiction", "sub_genre" => "autobiography", "height" => 197, "publisher" => "Hyperion",],
            ...
            ["title" => "Russian Journal, A", "author" => "Steinbeck, John", "genre" => "nonfiction", "sub_genre" => "history", "height" => 196, "publisher" => "Penguin",],
            ...
            ["title" => "Once There Was a War", "author" => "Steinbeck, John", "genre" => "nonfiction", "sub_genre" => "history", "height" => 196, "publisher" => "Penguin",],
            ...
            ["title" => "Complete Mastermind, The", "author" => "BBC", "genre" => "nonfiction", "sub_genre" => "trivia", "height" => 178, "publisher" => "BBC",],
            ["title" => "Dylan on Dylan", "author" => "Dylan, Bob", "genre" => "nonfiction", "sub_genre" => "autobiography", "height" => 197, "publisher" => "Random House",],
            ["title" => "Soft Computing & Intelligent Systems", "author" => "Gupta, Madan", "genre" => "tech", "sub_genre" => "data science", "height" => 242, "publisher" => "Elsevier",],
            ["title" => "Textbook of Economic Theory", "author" => "Stonier, Alfred", "genre" => "tech", "sub_genre" => "economics", "height" => 242, "publisher" => "Pearson",],
            ["title" => "Econometric Analysis", "author" => "Greene, W. H.", "genre" => "tech", "sub_genre" => "economics", "height" => 242, "publisher" => "Pearson",],
            ["title" => "Learning OpenCV", "author" => "Bradsky, Gary", "genre" => "tech", "sub_genre" => "signal processing", "height" => 232, "publisher" => "O'Reilly",],
            ["title" => "Data Structures Using C & C++", "author" => "Tanenbaum, Andrew", "genre" => "tech", "sub_genre" => "computer science", "height" => 235, "publisher" => "Prentice Hall",],
            ["title" => "Computer Vision, A Modern Approach", "author" => "Forsyth, David", "genre" => "tech", "sub_genre" => "signal processing", "height" => 255, "publisher" => "Pearson",],
            ["title" => "Principles of Communication Systems", "author" => "Taub, Schilling", "genre" => "tech", "sub_genre" => "signal processing", "height" => 240, "publisher" => "TMH",],
            ["title" => "Let Us C", "author" => "Kanetkar, Yashwant", "genre" => "tech", "sub_genre" => "computer science", "height" => 213, "publisher" => "Prentice Hall",],
            ...
            ["title" => "Argumentative Indian, The", "author" => "Sen, Amartya", "genre" => "nonfiction", "sub_genre" => "history", "height" => 209, "publisher" => "Picador",],
            ...
            ["title" => "All the President's Men", "author" => "Woodward, Bob", "genre" => "nonfiction", "sub_genre" => "history", "height" => 177, "publisher" => "Random House",],
            ["title" => "Prisoner of Birth, A", "author" => "Archer, Jeffery", "genre" => "fiction", "sub_genre" => "novel", "height" => 176, "publisher" => "Pan",],
            ["title" => "Scoop!", "author" => "Nayar, Kuldip", "genre" => "nonfiction", "sub_genre" => "history", "height" => 216, "publisher" => "Harper Collins",],
            ["title" => "Ahe Manohar Tari", "author" => "Desh Pande, Sunita", "genre" => "nonfiction", "sub_genre" => "autobiography", "height" => 213, "publisher" => "Mauj",],
            ["title" => "Last Mughal, The", "author" => "Dalrymple, William", "genre" => "nonfiction", "sub_genre" => "history", "height" => 199, "publisher" => "Penguin",],
            ["title" => "Social Choice & Welfare, Vol 39 No. 1", "author" => "Various", "genre" => "tech", "sub_genre" => "economics", "height" => 235, "publisher" => "Springer",],
            ["title" => "Radiowaril Bhashane & Shrutika", "author" => "Desh Pande, P L", "genre" => "nonfiction", "sub_genre" => "misc", "height" => 213, "publisher" => "Mauj",],
            ["title" => "Gun Gayin Awadi", "author" => "Desh Pande, P L", "genre" => "nonfiction", "sub_genre" => "misc", "height" => 212, "publisher" => "Mauj",],
            ["title" => "Aghal Paghal", "author" => "Desh Pande, P L", "genre" => "nonfiction", "sub_genre" => "misc", "height" => 212, "publisher" => "Mauj",],
            ["title" => "Maqta-e-Ghalib", "author" => "Garg, Sanjay", "genre" => "nonfiction", "sub_genre" => "poetry", "height" => 221, "publisher" => "Mauj",],
            ["title" => "Beyond Degrees", "author" => "", "genre" => "philosophy", "sub_genre" => "education", "height" => 222, "publisher" => "Harper Collins",],
            ["title" => "Manasa", "author" => "Kale, V P", "genre" => "nonfiction", "sub_genre" => "misc", "height" => 213, "publisher" => "Mauj",],
            ["title" => "India from Midnight to Milennium", "author" => "Tharoor, Shashi", "genre" => "nonfiction", "sub_genre" => "history", "height" => 198, "publisher" => "Penguin",],
            ["title" => "World's Greatest Trials, The", "author" => "", "genre" => "nonfiction", "sub_genre" => "history", "height" => 210, "publisher" => "",],
            ["title" => "Great Indian Novel, The", "author" => "Tharoor, Shashi", "genre" => "fiction", "sub_genre" => "novel", "height" => 198, "publisher" => "Penguin",],
            ["title" => "O Jerusalem!", "author" => "Lapierre, Dominique", "genre" => "nonfiction", "sub_genre" => "history", "height" => 217, "publisher" => "vikas",],
            ["title" => "City of Joy, The", "author" => "Lapierre, Dominique", "genre" => "fiction", "sub_genre" => "novel", "height" => 177, "publisher" => "vikas",],
            ["title" => "Freedom at Midnight", "author" => "Lapierre, Dominique", "genre" => "nonfiction", "sub_genre" => "history", "height" => 167, "publisher" => "vikas",],
            ...
            ["title" => "Free Will", "author" => "Harris, Sam", "genre" => "nonfiction", "sub_genre" => "psychology", "height" => 203, "publisher" => "FreePress",],
            ["title" => "Bookless in Baghdad", "author" => "Tharoor, Shashi", "genre" => "nonfiction", "sub_genre" => "history", "height" => 206, "publisher" => "Penguin",],
            ...
            ["title" => "Age of Discontuinity, The", "author" => "Drucker, Peter", "genre" => "nonfiction", "sub_genre" => "economics", "height" => 178, "publisher" => "Random House",],
            ["title" => "Doctor in the Nude", "author" => "Gordon, Richard", "genre" => "fiction", "sub_genre" => "novel", "height" => 179, "publisher" => "Penguin",],
            ["title" => "Down and Out in Paris & London", "author" => "Orwell, George", "genre" => "nonfiction", "sub_genre" => "autobiography", "height" => 179, "publisher" => "Penguin",],
            ["title" => "Identity & Violence", "author" => "Sen, Amartya", "genre" => "philosophy", "sub_genre" => "philosophy", "height" => 219, "publisher" => "Penguin",],
            ["title" => "Beyond the Three Seas", "author" => "Dalrymple, William", "genre" => "nonfiction", "sub_genre" => "history", "height" => 197, "publisher" => "Random House",],
            ["title" => "World's Greatest Short Stories, The", "author" => "", "genre" => "fiction", "sub_genre" => "classic", "height" => 217, "publisher" => "Jaico",],
            ["title" => "Talking Straight", "author" => "Iacoca, Lee", "genre" => "nonfiction", "sub_genre" => "autobiography", "height" => 175, "publisher" => "",],
            ...
            ["title" => "Great War for Civilization, The", "author" => "Fisk, Robert", "genre" => "nonfiction", "sub_genre" => "history", "height" => 197, "publisher" => "Harper Collins",],
            ...
            ["title" => "Clash of Civilizations and Remaking of the World Order", "author" => "Huntington, Samuel", "genre" => "nonfiction", "sub_genre" => "history", "height" => 228, "publisher" => "Simon & Schuster",],
            ["title" => "Uncommon Wisdom", "author" => "Capra, Fritjof", "genre" => "nonfiction", "sub_genre" => "anthology", "height" => 197, "publisher" => "Fontana",],
            ["title" => "One", "author" => "Bach, Richard", "genre" => "nonfiction", "sub_genre" => "autobiography", "height" => 172, "publisher" => "Dell",],
            ["title" => "Karl Marx Biography", "author" => "", "genre" => "nonfiction", "sub_genre" => "autobiography", "height" => 162, "publisher" => "",],
            ...
            ["title" => "Discovery of India, The", "author" => "Nehru, Jawaharlal", "genre" => "nonfiction", "sub_genre" => "history", "height" => 230, "publisher" => "",],
            ["title" => "Apulki", "author" => "Desh Pande, P L", "genre" => "nonfiction", "sub_genre" => "misc", "height" => 211, "publisher" => "",],
            ...
            ["title" => "Veil: Secret Wars of the CIA", "author" => "Woodward, Bob", "genre" => "nonfiction", "sub_genre" => "history", "height" => 171, "publisher" => "",],
            ["title" => "Char Shabda", "author" => "Desh Pande, P L", "genre" => "nonfiction", "sub_genre" => "misc", "height" => 214, "publisher" => "",],
            ...
            ["title" => "Short history of the World, A", "author" => "Wells, H G", "genre" => "nonfiction", "sub_genre" => "history", "height" => 197, "publisher" => "",],
            ...
            ["title" => "Pattern Classification", "author" => "Duda, Hart", "genre" => "tech", "sub_genre" => "data science", "height" => 241, "publisher" => "",],
            ["title" => "From Beirut to Jerusalem", "author" => "Friedman, Thomas", "genre" => "nonfiction", "sub_genre" => "history", "height" => 202, "publisher" => "",],
            ["title" => "Code Book, The", "author" => "Singh, Simon", "genre" => "science", "sub_genre" => "mathematics", "height" => 197, "publisher" => "",],
            ["title" => "Age of the Warrior, The", "author" => "Fisk, Robert", "genre" => "nonfiction", "sub_genre" => "history", "height" => 197, "publisher" => "",],
            ...
            ["title" => "Life in Letters, A", "author" => "Steinbeck, John", "genre" => "nonfiction", "sub_genre" => "autobiography", "height" => 196, "publisher" => "",],
            ...
            ["title" => "Elements of Information Theory", "author" => "Thomas, Joy", "genre" => "tech", "sub_genre" => "signal processing", "height" => 229, "publisher" => "",],
            ["title" => "Power Electronics - Rashid", "author" => "Rashid, Muhammad", "genre" => "tech", "sub_genre" => "computer science", "height" => 235, "publisher" => "",],
            ["title" => "Power Electronics - Mohan", "author" => "Mohan, Ned", "genre" => "tech", "sub_genre" => "computer science", "height" => 237, "publisher" => "",],
            ["title" => "Neural Networks", "author" => "Haykin, Simon", "genre" => "tech", "sub_genre" => "data science", "height" => 240, "publisher" => "",],
            ["title" => "Grapes of Wrath, The", "author" => "Steinbeck, John", "genre" => "fiction", "sub_genre" => "classic", "height" => 196, "publisher" => "",],
            ["title" => "Vyakti ani Valli", "author" => "Desh Pande, P L", "genre" => "nonfiction", "sub_genre" => "misc", "height" => 211, "publisher" => "",],
            ["title" => "Statistical Learning Theory", "author" => "Vapnik, Vladimir", "genre" => "tech", "sub_genre" => "data science", "height" => 228, "publisher" => "",],
            ["title" => "Empire of the Mughal - The Tainted Throne", "author" => "Rutherford, Alex", "genre" => "nonfiction", "sub_genre" => "history", "height" => 180, "publisher" => "",],
            ["title" => "Empire of the Mughal - Brothers at War", "author" => "Rutherford, Alex", "genre" => "nonfiction", "sub_genre" => "history", "height" => 180, "publisher" => "",],
            ["title" => "Empire of the Mughal - Ruler of the World", "author" => "Rutherford, Alex", "genre" => "nonfiction", "sub_genre" => "history", "height" => 180, "publisher" => "",],
            ["title" => "Empire of the Mughal - The Serpent's Tooth", "author" => "Rutherford, Alex", "genre" => "nonfiction", "sub_genre" => "history", "height" => 180, "publisher" => "",],
            ["title" => "Empire of the Mughal - Raiders from the North", "author" => "Rutherford, Alex", "genre" => "nonfiction", "sub_genre" => "history", "height" => 180, "publisher" => "",],
            ["title" => "Mossad", "author" => "Baz-Zohar, Michael", "genre" => "nonfiction", "sub_genre" => "history", "height" => 236, "publisher" => "",],
            ["title" => "Jim Corbett Omnibus", "author" => "Corbett, Jim", "genre" => "nonfiction", "sub_genre" => "history", "height" => 223, "publisher" => "",],
            ...
            ["title" => "Pointers in C", "author" => "Kanetkar, Yashwant", "genre" => "tech", "sub_genre" => "computer science", "height" => 213, "publisher" => "",],
            ["title" => "Cathedral and the Bazaar, The", "author" => "Raymond, Eric", "genre" => "tech", "sub_genre" => "computer science", "height" => 217, "publisher" => "",],
            ["title" => "Design with OpAmps", "author" => "Franco, Sergio", "genre" => "tech", "sub_genre" => "computer science", "height" => 240, "publisher" => "",],
            ["title" => "Think Complexity", "author" => "Downey, Allen", "genre" => "tech", "sub_genre" => "data science", "height" => 230, "publisher" => "",],
            ...
            ["title" => "Data Analysis with Open Source Tools", "author" => "Janert, Phillip", "genre" => "tech", "sub_genre" => "data science", "height" => 230, "publisher" => "",],
            ...
            ["title" => "Justice, Judiciary and Democracy", "author" => "Ranjan, Sudhanshu", "genre" => "nonfiction", "sub_genre" => "legal", "height" => 224, "publisher" => "",],
            ...
            ["title" => "Courtroom Genius, The", "author" => "Sorabjee   ", "genre" => "nonfiction", "sub_genre" => "autobiography", "height" => 217, "publisher" => "",],
            ["title" => "Dongri to Dubai", "author" => "Zaidi, Hussain", "genre" => "nonfiction", "sub_genre" => "history", "height" => 216, "publisher" => "",],
            ["title" => "History of England, Foundation", "author" => "Ackroyd, Peter", "genre" => "nonfiction", "sub_genre" => "history", "height" => 197, "publisher" => "",],
            ["title" => "City of Djinns", "author" => "Dalrymple, William", "genre" => "nonfiction", "sub_genre" => "history", "height" => 198, "publisher" => "",],
            ["title" => "India's Legal System", "author" => "Nariman", "genre" => "nonfiction", "sub_genre" => "legal", "height" => 177, "publisher" => "",],
            ...
            ["title" => "Image Processing with MATLAB", "author" => "Eddins, Steve", "genre" => "tech", "sub_genre" => "signal processing", "height" => 241, "publisher" => "",],
